...
function saveSettings() { try { localStorage.setItem(SETTINGS_KEY, JSON.stringify({ theme: state.theme, lang: state.lang, currency: state.currency, objetivo: state.objetivo, apiBaseUrl: state.apiBaseUrl, textSize: state.textSize })); } catch (e) {} }
