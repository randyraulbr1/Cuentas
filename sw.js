const CACHE = "cuentas-claras-v140"
const ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./src/css/components.css?v=v140",
  "./src/css/pages.css?v=v140",
