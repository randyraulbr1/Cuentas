const CACHE = "cuentas-claras-v123";
const ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./src/js/render.js?v=v123",
  "./src/js/app.js?v=v123",
