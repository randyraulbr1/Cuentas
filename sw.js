const CACHE = "cuentas-claras-v107";
const ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./src/js/recommendations.js?v=v107",
  "./src/js/render.js?v=v107",
  "./src/js/app.js?v=v107",
