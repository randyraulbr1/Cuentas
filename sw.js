const CACHE = "cuentas-claras-v128";
const ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./src/js/recommendations.js?v=v127",
  "./src/js/render.js?v=v128",
  "./src/js/app.js?v=v128",
