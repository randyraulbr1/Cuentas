const CACHE = "cuentas-claras-v129";
const ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./src/css/components.css?v=v129",
  "./src/css/pages.css?v=v117",
  ...
  "./src/js/state.js?v=v129",
  "./src/js/calculations.js?v=v116",
  "./src/js/categories.js?v=v86",
  "./src/js/work.js?v=v126",
  "./src/js/payments.js?v=v107",
  "./src/js/bank.js?v=v129",
  "./src/js/api.js?v=v104",
  "./src/js/plaid-link.js?v=v86",
  "./src/js/history.js?v=v86",
  "./src/js/recommendations.js?v=v129",
  "./src/js/render.js?v=v129",
  "./src/js/app.js?v=v129",
